...
3. This guide sets up a public IP address AND a tor service address. This means that your tor service address is NOT considered private. However this does help the network for users who exclusively need tor only connections. If you find you need to switch to tor only privacy later, for `bitcoind` delete your onion service private key to get a new onion address. For `lnd`, close all channels, change your node alias, delete your onion service private key to get a new onion address.
