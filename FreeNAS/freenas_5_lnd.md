...
# service lnd stop
# cd ~
# wget https://github.com/lightningnetwork/lnd/releases/download/v0.8.0-beta/lnd-freebsd-amd64-v0.8.0-beta.tar.gz
# tar -xvf lnd-freebsd-amd64-v0.8.0-beta.tar.gz
# cd lnd-freebsd-amd64-v0.8.0-beta
# install -m 0755 -o root -g wheel lnd lncli /usr/local/bin
# cd ~
