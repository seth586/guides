...
# cd ~
# wget https://github.com/lightningnetwork/lnd/releases/download/v0.15.4-beta/lnd-freebsd-amd64-v0.15.4-beta.tar.gz
...
# service lnd stop
# cd ~
# wget https://github.com/lightningnetwork/lnd/releases/download/v0.15.4-beta/lnd-freebsd-amd64-v0.15.3-beta.tar.gz
# tar -xvf lnd-freebsd-amd64*
# install -m 0755 -o root -g wheel ~/lnd-freebsd-amd64*/* /usr/local/bin
# rm -r /lnd-freebsd-amd64* lnd-freebsd-amd64*
